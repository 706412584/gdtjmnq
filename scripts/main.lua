...
--- GDD 色板
local COLORS = {
    bgPrimary    = { 26,  26,  46,  255 },  -- #1A1A2E 炭黑
    bgSecondary  = { 22,  33,  62,  255 },  -- #16213E 深铁蓝
    accent       = { 233, 69,  96,  255 },  -- #E94560 炉火红
    gold         = { 212, 165, 116, 255 },  -- #D4A574 鎏金
    textPrimary  = { 232, 224, 208, 255 },  -- #E8E0D0 暖白
...
function Start()
    ...
    GameState.Load(function(success)
        ...
        if StoryManager.HasPendingStory() then
            ...
            print("[main] Pending story at " .. chapter .. ":" .. nodeId .. ", entering story screen")
...
-- ============================================================================
-- Screen 注册（占位版，后续由各 Screen 模块文件替换）
-- ============================================================================
