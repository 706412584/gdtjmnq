# 2D 像素瓦片 Demo 最终修复版本代码
来源提交：`6a44f6c08ed7bd993b69f80e48a831628f96f73a`
提交说明：`fix: 修正props位置和尺寸(使用正确的视口转换)`
说明：这是 `docs/2d像素瓦片` demo 被后续大同步删除前，最后一个包含瓦片庭院实现的可查看版本。

## `scripts/scene2d_2D瓦片庭院.lua`
